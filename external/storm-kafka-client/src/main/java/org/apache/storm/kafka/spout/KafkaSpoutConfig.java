...
public class KafkaSpoutConfig<K,V> implements Serializable {
  public static long serialVersionUID=141902646130682494L;
  public static long DEFAULT_POLL_TIMEOUT_MS=200;
  public static long DEFAULT_OFFSET_COMMIT_PERIOD_MS=30_000;
  public static int DEFAULT_MAX_RETRIES=Integer.MAX_VALUE;
  public static int DEFAULT_MAX_UNCOMMITTED_OFFSETS=10_000_000;
  public static long DEFAULT_PARTITION_REFRESH_PERIOD_MS=2_000;
  public static KafkaSpoutRetryService DEFAULT_RETRY_SERVICE=new KafkaSpoutRetryExponentialBackoff(TimeInterval.seconds(0),TimeInterval.milliSeconds(2),DEFAULT_MAX_RETRIES,TimeInterval.seconds(10));
  /** 
 * Retry in a tight loop (keep unit tests fasts) do not use in production.
 */
  public static KafkaSpoutRetryService UNIT_TEST_RETRY_SERVICE=new KafkaSpoutRetryExponentialBackoff(TimeInterval.seconds(0),TimeInterval.milliSeconds(0),DEFAULT_MAX_RETRIES,TimeInterval.milliSeconds(0));
  /** 
 * The offset used by the Kafka spout in the first poll to Kafka broker. The choice of this parameter will affect the number of consumer records returned in the first poll. By default this parameter is set to UNCOMMITTED_EARLIEST. <br/><br/> The allowed values are EARLIEST, LATEST, UNCOMMITTED_EARLIEST, UNCOMMITTED_LATEST. <br/> <ul> <li>EARLIEST means that the kafka spout polls records starting in the first offset of the partition, regardless of previous commits</li> <li>LATEST means that the kafka spout polls records with offsets greater than the last offset in the partition, regardless of previous commits</li> <li>UNCOMMITTED_EARLIEST means that the kafka spout polls records from the last committed offset, if any. If no offset has been committed, it behaves as EARLIEST.</li> <li>UNCOMMITTED_LATEST means that the kafka spout polls records from the last committed offset, if any. If no offset has been committed, it behaves as LATEST.</li> </ul>
 */
  public static enum FirstPollOffsetStrategy {  EARLIEST,   LATEST,   UNCOMMITTED_EARLIEST,   UNCOMMITTED_LATEST}
  ...
  public static Map<String,Object> setDefaultsAndGetKafkaProps(  Map<String,Object> kafkaProps){
...
public static class Builder<K,V> {
    ...
    public SerializableDeserializer<K> keyDes;
    public Class<? extends Deserializer<K>> keyDesClazz;
    public SerializableDeserializer<V> valueDes;
    public Class<? extends Deserializer<V>> valueDesClazz;
    public RecordTranslator<K,V> translator;
    public long pollTimeoutMs=DEFAULT_POLL_TIMEOUT_MS;
    public long offsetCommitPeriodMs=DEFAULT_OFFSET_COMMIT_PERIOD_MS;
    public FirstPollOffsetStrategy firstPollOffsetStrategy=FirstPollOffsetStrategy.UNCOMMITTED_EARLIEST;
    public int maxUncommittedOffsets=DEFAULT_MAX_UNCOMMITTED_OFFSETS;
    public KafkaSpoutRetryService retryService=DEFAULT_RETRY_SERVICE;
    public long partitionRefreshPeriodMs=DEFAULT_PARTITION_REFRESH_PERIOD_MS;
    ...
    public Builder(    String bootstrapServers,    SerializableDeserializer<K> keyDes,    Class<? extends Deserializer<K>> keyDesClazz,    SerializableDeserializer<V> valDes,    Class<? extends Deserializer<V>> valDesClazz,    Subscription subscription){
    ...
    public Builder(    Builder<?,?> builder,    SerializableDeserializer<K> keyDes,    Class<? extends Deserializer<K>> keyDesClazz,    SerializableDeserializer<V> valueDes,    Class<? extends Deserializer<V>> valueDesClazz){
    ...
    /** 
 * Specifying this key deserializer overrides the property key.deserializer. If you have set a custom RecordTranslator before calling this it may result in class cast exceptions at runtime.
 */
    ...
    /** 
 * Specify a class that can be instantiated to create a key.deserializer This is the same as setting key.deserializer, but overrides it. If you have set a custom RecordTranslator before calling this it may result in class cast exceptions at runtime.
 */
    ...
    /** 
 * Specifying this value deserializer overrides the property value.deserializer.  If you have set a custom RecordTranslator before calling this it may result in class cast exceptions at runtime.
 */
    ...
    /** 
 * Specify a class that can be instantiated to create a value.deserializer This is the same as setting value.deserializer, but overrides it.  If you have set a custom RecordTranslator before calling this it may result in class cast exceptions at runtime.
 */
 ...
 */
    ...
    /** 
 * The maximum number of records a poll will return. Will only work with Kafka 0.10.0 and above.
 */
 ...
 */
    public Builder<K,V> setSSLKeystore(    String location,    String password){
      return setProp("ssl.keystore.location",location).setProp("ssl.keystore.password",password);
    }
    /** 
 * Configure the SSL Keystore for mutual authentication
 */
    public Builder<K,V> setSSLKeystore(    String location,    String password,    String keyPassword){
      return setProp("ssl.key.password",keyPassword).setSSLKeystore(location,password);
    }
    /** 
 ...
 */
    public Builder<K,V> setSSLTruststore(    String location,    String password){
      return setSecurityProtocol("SSL").setProp("ssl.truststore.location",location).setProp("ssl.truststore.password",password);
    }
    /** 
 ...
 */
    ...
    /** 
 * Sets the offset used by the Kafka spout in the first poll to Kafka broker upon process start. Please refer to to the documentation in   {@link FirstPollOffsetStrategy}
 ...
 */
  ...
  public RecordTranslator<K,V> translator;
  public long offsetCommitPeriodMs;
  public int maxUncommittedOffsets;
  public FirstPollOffsetStrategy firstPollOffsetStrategy;
  public KafkaSpoutRetryService retryService;
  public long partitionRefreshPeriodMs;
  ...
  public boolean isConsumerAutoCommitMode(){
    return kafkaProps.get(ConsumerConfig.ENABLE_AUTO_COMMIT_CONFIG) == null || Boolean.valueOf((String)kafkaProps.get(ConsumerConfig.ENABLE_AUTO_COMMIT_CONFIG));
  }
  ...
  @Override public String toString(){
    return "KafkaSpoutConfig{" + "kafkaProps=" + kafkaProps + ", key="+ getKeyDeserializer()+ ", value="+ getValueDeserializer()+ ", pollTimeoutMs="+ pollTimeoutMs+ ", offsetCommitPeriodMs="+ offsetCommitPeriodMs+ ", maxUncommittedOffsets="+ maxUncommittedOffsets+ ", firstPollOffsetStrategy="+ firstPollOffsetStrategy+ ", subscription="+ subscription+ ", translator="+ translator+ ", retryService="+ retryService+ '}';
  }
